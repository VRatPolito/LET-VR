...
public class KATDevice : MonoBehaviour
{
    ...
    public float multiply, multiplyBack, maxSpeed = 7.0f;
    public MovementStyleList MovementStyle;

    [HideInInspector] public Rigidbody target_Rig;
    [HideInInspector] public CharacterController target_Controller;
    public KeyCode ResetCameraKey;

    [Header("Real-Time Values")] public State CurrentState;
    [Range(0, 1)] public float CurrentSpeed = 0.0f;
    [Range(0, 360)] public float CurrentRotation = 0.0f;
                ...
                else if (MovementStyle == MovementStyleList.CharacterController)
                {
                    if (target_Controller == null)
                    {
                        ...
                        else
                        {
                            MovementStyle = MovementStyleList.Translate;
                            Debug.LogWarning(
                                "Can not find CharacterController component in Movement Object, the Movement Style will be changed to Translate.");
                        }
                    }
                }
    ...
    private void TargetTransform(MovementStyleList Type)
    {
        ...
        KATDevice_Walk.Instance.Data.moveSpeed.Clamp(-maxSpeed, maxSpeed);
        ...
        switch (Type)
        {
            ...
            case MovementStyleList.Translate:
                ...
                targetMoveObject.position += (targetRotateObject.forward / 100 *
                                              KATDevice_Walk.Instance.Data.moveSpeed *
                                              KATDevice_Walk.Instance.Data.moveDirection);
                targetRotateObject.localEulerAngles = new Vector3(targetRotateObject.localEulerAngles.x,
                    KATDevice_Walk.Instance.Data.bodyYaw, targetRotateObject.localEulerAngles.z);
                break;
            ...
            case MovementStyleList.Velocity:
                target_Rig.velocity = targetRotateObject.forward * KATDevice_Walk.Instance.Data.moveSpeed *
                                      KATDevice_Walk.Instance.Data.moveDirection;
                targetRotateObject.localEulerAngles = new Vector3(targetRotateObject.localEulerAngles.x,
                    KATDevice_Walk.Instance.Data.bodyYaw, targetRotateObject.localEulerAngles.z);
                break;
            ...
            case MovementStyleList.CharacterController:
                ...
                if (target_Controller.isGrounded)
                    moveDirection = targetRotateObject.forward / 100 * KATDevice_Walk.Instance.Data.moveSpeed *
                                    KATDevice_Walk.Instance.Data.moveDirection;
